...
export const SubmissionsGetEventsInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsGetPayoutsInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsGetIntegrationsInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsGetPossibleGroupsInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
const MoneyCreateSchema = z.object({
  ...
  currency: z
    ...
    .max(3)
    .optional()
    .describe("ISO 4217 3-letter currency code, e.g. USD or EUR"),
}).strict();

export const SubmissionsAddCompanyBonusInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsExportPdfInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsExportCsvInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsAddAttachmentInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsPlaceInternalMessageInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsPlaceExternalMessageInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsAddTagInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
  tag: z.string().min(1).optional().describe("Tag string to add to the submission"),
}).strict();
export type SubmissionsAddTagInput = z.infer<typeof SubmissionsAddTagInputSchema>;

export const SubmissionsSetCustomBountyInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsUpdateInternalReferenceInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsUpdateSeverityInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsAssignToMeInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsUpdatePersonalDataInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsUpdateAwaitingFeedbackInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsUpdateGroupInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsUpdateAssetInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsDeleteCompanyBonusInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
...
export const SubmissionsRemoveTagInputSchema = z.object({
  submissionCode: z
    .string()
    .min(1)
    .describe("Unique code identifying the submission"),
